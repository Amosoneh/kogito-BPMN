...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "traffic_rules_dmn", name = "Traffic_rules_dmn", hidden = false)
public class Traffic_rules_dmnModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<Traffic_rules_dmnModelOutput> {
    ...
    @Override()
    public Traffic_rules_dmnModelOutput toModel() {
        Traffic_rules_dmnModelOutput result = new Traffic_rules_dmnModelOutput();
        result.setId(getId());
